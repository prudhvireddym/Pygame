# -*- coding: utf-8 -*-
"""
Created on Mon Mar 23 22:36:53 2020
...
def main(genomes, config):
    ...
    while True:
        for _, g in genomes:
            g.fitness = 0
            nets = neat.nn.FeedForwardNetwork.create(g, config)
            ...
            for i in range(0, 6):
                ...
                if colide:
                    ...
                    mixer.music.play()
            output = nets.activate((playerX,math.sqrt(math.pow((enemyX[0]-playerX),2)+math.pow((enemyY[0]-playerY),2))))
